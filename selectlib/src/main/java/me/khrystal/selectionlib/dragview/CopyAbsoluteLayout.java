...
public class CopyAbsoluteLayout extends ViewGroup {

    public CopyAbsoluteLayout(Context context) {
        super(context);
    }

    public CopyAbsoluteLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE) {
                ...
                CopyAbsoluteLayout.LayoutParams lp
                        = (CopyAbsoluteLayout.LayoutParams) child.getLayoutParams();
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new CopyAbsoluteLayout.LayoutParams(getContext(), attrs);
    }

    // Override to allow type-checking of LayoutParams.
    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof CopyAbsoluteLayout.LayoutParams;
    }
