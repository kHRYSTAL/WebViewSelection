...
public class BridgeAdapter implements WebViewJavascriptBridge {
    ...
    public BridgeAdapter(WebView webView, WebViewClient client) {
        if (webView == null)
        ...
        webView.setWebViewClient(generateBridgeWebViewClient(client));
    }

    private WebViewClient generateBridgeWebViewClient(WebViewClient client) {
        return new BridgeWebViewClient(this, client);
    }
